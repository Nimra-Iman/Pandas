...
# s koi ek column common ho or us common valy column ko "on" m pass krna h. agar "on"
...
# kro to izafi columns bny gy,,,, axis = 0 means vertical yani more rows
...
# print(pd.concat([d1,d2], keys=["a","b"], axis=1))
